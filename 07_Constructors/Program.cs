...
namespace _07_Constructors
{
    ...
    class LoneDigger
    {
        public LoneDigger()
        {
            Console.WriteLine("Lone Digger baby!");
        }
    }
    ...
    class Car
    {
        ...
        public Car()
        {
            Console.WriteLine("That sentence created automaticly.");
        }
    ...
    class Program
    {
        ...
        {
            LoneDigger ld = new LoneDigger();
            LoneDigger ld2 = new LoneDigger();
            ...
            Car Ring = new Car(speedLimit: 900);
            Ring.Menu();
